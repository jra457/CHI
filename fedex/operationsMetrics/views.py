...
# ~~~~~ Volume Availability Status Classes ~~~~~
class volumeAvailabilityStatusListView(generic.ListView):
    """Generic class-based list view for a region."""
    model = volumeAvailabilityStatus

class volumeAvailabilityStatusDetailView(generic.DetailView):
    """Generic class-based detail view for a region."""
    model = volumeAvailabilityStatus
# ~~~~~
...
# ~~~~~ DEX Classes ~~~~~
class DEXListView(generic.ListView):
    """Generic class-based list view for a region."""
    model = DEX

class DEXDetailView(generic.DetailView):
    """Generic class-based detail view for a region."""
    model = DEX
# ~~~~~